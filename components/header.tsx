      ...
      <div className="container mx-auto px-4 py-4">
        ...
        {isMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 border-t pt-4 space-y-4">
            ...
            <Link href="/ai-features" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
            ...
            <Link href="/ai-content-studio" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
